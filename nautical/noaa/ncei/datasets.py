...
class Dataset(NCEIBase):
    ...
    '''
    All of the CDO data are in datasets. The containing dataset must be known before 
    ...
    Additional Parameters
        ...
        startdate [Optional] 
            Accepts valid ISO formated date (yyyy-mm-dd). Datasets returned will have data
